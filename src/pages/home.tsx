        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-lg mb-6">
              ...
              educational content for students, professionals, and enthusiasts.
              Our goal is to empower learners with practical skills that will
              help them succeed in the tech industry.
            </p>
            <p className="text-lg mb-6">
              We focus on delivering well-structured tutorials, expert advice,
              and hands-on projects to help you learn web development at your
              own pace. Whether you're a beginner or an experienced developer,
              our resources are designed to support you throughout your learning
              journey.
            </p>
            <img
          ...
          <div>
            ...
            <p className="text-lg mb-6">
              SyntixDesigner was founded with the mission of making tech
              education accessible to everyone. Our team comprises passionate
              developers, designers, and educators who work tirelessly to create
              a seamless learning experience.
            </p>
            <p className="text-lg mb-6">
              With years of experience in the industry, our company emphasizes
              innovation, collaboration, and a commitment to excellence. Join us
              on our journey to make learning exciting and impactful.
            </p>
            <img
              src="/src/assets/tutorials.jpg"
              alt="Company Image"
